...
async function main() {
  ...
  // ── Courses ─────────────────────────────────────────────────────────────────
  const courses = [
    { id: 'course-1', thumbnailUrl: '/images/course-1.svg', title: 'Основы авиационного английского',           description: 'Вводный курс для начинающих. Базовая лексика, фонетика и структура радиообмена.',                                          level: 'Pre-Aviation',   price: 0,      currency: 'KZT', lessonsCount: 12, duration: 8,  studentsCount: 847  },
    { id: 'course-2', thumbnailUrl: '/images/course-2.svg', title: 'Подготовка к ICAO Level 3',                  description: 'Интенсивный курс для достижения предрабочего уровня владения авиационным английским.',                                    level: 'ICAO Level 3',   price: 75000,  currency: 'KZT', lessonsCount: 24, duration: 16, studentsCount: 523  },
    { id: 'course-3', thumbnailUrl: '/images/course-3.svg', title: 'ICAO Level 4 для пилотов',                   description: 'Комплексная подготовка к экзамену ICAO Level 4. Все аспекты: аудирование, говорение, чтение.',                          level: 'ICAO Level 4',   price: 120000, currency: 'KZT', lessonsCount: 36, duration: 24, studentsCount: 1256 },
    { id: 'course-4', thumbnailUrl: '/images/course-4.svg', title: 'ICAO Level 4 для диспетчеров',               description: 'Специализированный курс для авиадиспетчеров с фокусом на радиообмен и нестандартные ситуации.',                        level: 'ICAO Level 4',   price: 130000, currency: 'KZT', lessonsCount: 32, duration: 22, studentsCount: 412  },
    { id: 'course-5', thumbnailUrl: '/images/course-5.svg', title: 'Продвинутый курс ICAO Level 5',              description: 'Для тех, кто хочет повысить уровень с 4 до 5. Сложные конструкции, идиомы, работа с акцентами.',                       level: 'ICAO Level 5-6', price: 180000, currency: 'KZT', lessonsCount: 28, duration: 20, studentsCount: 234  },
    { id: 'course-6', thumbnailUrl: '/images/course-6.svg', title: 'Корпоративная программа',                    description: 'Индивидуальная программа обучения для авиакомпаний и учебных центров.',                                                 level: 'Corporate',      price: 0,      currency: 'KZT', lessonsCount: 0,  duration: 0,  studentsCount: 18   },
  ];
